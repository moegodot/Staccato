...
use staccato_shared::event::{
    AppEvent, DeviceOperation, Event, InlineText, RawEvent, UserOperation, WindowEvent,
};
        ...
        match sdl_type {
            ...
            SDL_EventType::WILL_ENTER_BACKGROUND => {
                ...
                Event {
                    ns_timestamp: sdl.timestamp,
                    raw: RawEvent::App {
                        event: AppEvent::WillEnterBackground,
                    },
                }
            }
            SDL_EventType::DID_ENTER_BACKGROUND => {
                ...
                Event {
                    ns_timestamp: sdl.timestamp,
                    raw: RawEvent::App {
                        event: AppEvent::DidEnterBackground,
                    },
                }
            }
            SDL_EventType::WILL_ENTER_FOREGROUND => {
                ...
                Event {
                    ns_timestamp: sdl.timestamp,
                    raw: RawEvent::App {
                        event: AppEvent::WillEnterForeground,
                    },
                }
            }
            SDL_EventType::DID_ENTER_FOREGROUND => {
                ...
                Event {
                    ns_timestamp: sdl.timestamp,
                    raw: RawEvent::App {
                        event: AppEvent::DidEnterForeground,
                    },
                }
            }
            ...
            SDL_EventType::SYSTEM_THEME_CHANGED => {
                ...
                Event {
                    ns_timestamp: sdl.timestamp,
                    raw: RawEvent::App {
                        event: AppEvent::SystemThemeChanged,
                    },
                }
            }
            ...
            SDL_EventType::WINDOW_CLOSE_REQUESTED => {
                ...
                Event {
                    ns_timestamp: sdl.timestamp,
                    raw: RawEvent::WindowClose {
                        id: sdl.windowID.0.into(),
                    },
                }
            }
            ...
            | SDL_EventType::WINDOW_HDR_STATE_CHANGED => {
                ...
                let event = match sdl_type {
                    ...
                    SDL_EventType::WINDOW_EXPOSED => WindowEvent::Exposed {
                        is_live_resize: sdl.data1 != 0,
                    },
                    SDL_EventType::WINDOW_MOVED => WindowEvent::Moved {
                        position: Point::new(sdl.data1, sdl.data2),
                    },
                    SDL_EventType::WINDOW_RESIZED => WindowEvent::Resized {
                        size: Point::new(sdl.data1, sdl.data2),
                    },
                    SDL_EventType::WINDOW_PIXEL_SIZE_CHANGED => WindowEvent::PixelSizeChanged {
                        size: Point::new(sdl.data1, sdl.data2),
                    },
                    ...
                    SDL_EventType::WINDOW_DISPLAY_CHANGED => WindowEvent::DisplayChanged {
                        display_id: sdl.data1 as u32,
                    },
